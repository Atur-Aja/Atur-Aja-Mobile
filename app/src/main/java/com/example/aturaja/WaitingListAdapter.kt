...
class WaitingListAdapter(private val waitingList : ArrayList<WaitingList>) : RecyclerView.Adapter<WaitingListAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.waiting_list_layout,
            parent, false)
