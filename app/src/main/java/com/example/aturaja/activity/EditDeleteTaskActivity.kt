...
import com.example.aturaja.model.DeleteTaskResponse
import com.example.aturaja.model.TasksItem
import com.example.aturaja.model.TodoItem
import com.example.aturaja.model.UpdateTaskResponse
...
class EditDeleteTaskActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener,
    ...
    fun saveTask() {
        ...
        apiClient.getApiService(this).updateTask(id,
            ...
            description,
            dateSave,
            timeSave, priority.toInt(), todos, friends)
